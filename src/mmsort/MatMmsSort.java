...
//				範囲１の値はすべて範囲２の値より小さかった
	 ...
	 * @param workSize work area size / 作業領域サイズ
	 */
	public static <T> void matMmsSort(final T[] array, final int from, final int to, final Comparator<? super T> comparator, int workSize)
	{
		int range = (to - from);
		if (range <= 1)
			return ;
	...
	{
		matMmsSort(array, from, to, comparator, 0);
	}
