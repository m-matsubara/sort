...
set JVM_ARGS=-server
title %1 100 R
java.exe %JVM_ARGS% -classpath bin mmsort.SortTest %1 100 R I %TIMES%
title %1 100 R (Str)
java.exe %JVM_ARGS% -classpath bin mmsort.SortTest %1 100 R S %TIMES%
title %1 100 U
...
title %1 1000 R
java.exe %JVM_ARGS% -classpath bin  mmsort.SortTest %1 1000 R I %TIMES%
title %1 1000 R (Str)
java.exe %JVM_ARGS% -classpath bin  mmsort.SortTest %1 1000 R S %TIMES%
title %1 1000 U
...
title %1 10000 R
java.exe %JVM_ARGS% -classpath bin  mmsort.SortTest %1 10000 R I %TIMES%
title %1 10000 R (Str)
java.exe %JVM_ARGS% -classpath bin  mmsort.SortTest %1 10000 R S %TIMES%
title %1 10000 U
...
title %1 100000 R
java.exe %JVM_ARGS% -classpath bin  mmsort.SortTest %1 100000 R I %TIMES%
title %1 100000 R (Str)
java.exe %JVM_ARGS% -classpath bin  mmsort.SortTest %1 100000 R S %TIMES%
title %1 100000 U
...
title %1 1000000 R
java.exe %JVM_ARGS% -classpath bin  mmsort.SortTest %1 1000000 R I %TIMES%
title %1 1000000 R (Str)
java.exe %JVM_ARGS% -classpath bin  mmsort.SortTest %1 1000000 R S %TIMES%
title %1 1000000 U
...
title %1 10000000 R
java.exe %JVM_ARGS% -classpath bin  mmsort.SortTest %1 10000000 R I %TIMES%
title %1 10000000 R (Str)
java.exe %JVM_ARGS% -classpath bin  mmsort.SortTest %1 10000000 R S %TIMES%
title %1 10000000 U
...
rem java.exe %JVM_ARGS% -classpath bin  mmsort.SortTest %1 100000000 R I %TIMES%
rem title %1 100000000 R (Str)
rem java.exe %JVM_ARGS% -classpath bin  mmsort.SortTest %1 100000000 R S %TIMES%
rem title %1 100000000 U
rem java.exe %JVM_ARGS% -classpath bin  mmsort.SortTest %1 100000000 U I %TIMES%
rem title %1 100000000 H
rem java.exe %JVM_ARGS% -classpath bin  mmsort.SortTest %1 100000000 H I %TIMES%
rem title %1 100000000 A
rem java.exe %JVM_ARGS% -classpath bin  mmsort.SortTest %1 100000000 A I %TIMES%
rem title %1 100000000 D
rem java.exe %JVM_ARGS% -classpath bin  mmsort.SortTest %1 100000000 D I %TIMES%
rem title %1 100000000 F
rem java.exe %JVM_ARGS% -classpath bin  mmsort.SortTest %1 100000000 F I %TIMES%
